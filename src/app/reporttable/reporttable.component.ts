...
callDateApply1(trend){
   if(!trend){
    ...
    // let downloadurl2 = 'http://152.135.122.61:8872/api/export_tool_xls/?start_date=' + trend.startDate +'&end_date='+ trend.endDate;
    let downloadurl2 = 'http://152.135.122.61:8872/api/export_tool_xls/?start_date=' + trend.startDate +'&end_date='+ trend.endDate;
...
callDateApply3(trend){
   if(!trend){
     ...
     trend2={startDate:this.start.format('YYYY-MM-DD'),endDate:this.end.format('YYYY-MM-DD')}
     console.log(trend2);
     let downloadurl1 = 'http://152.135.122.61:8872/api/export_project_xls/?start_date=' + this.start.format('YYYY-MM-DD') +'&end_date='+ this.end.format('YYYY-MM-DD');
     window.open(downloadurl1);
    //  this._service.sendDateGetReprts(trend2).subscribe(data=>{
    //   //window.open(downloadurl1);
    // })
    ...
    console.log('else----------------------------')
    // let downloadurl2 = 'http://152.135.122.61:8872/api/export_tool_xls/?start_date=' + trend.startDate +'&end_date='+ trend.endDate;
    let downloadurl2 = 'http://152.135.122.61:8872/api/export_project_xls/?start_date=' + trend.startDate +'&end_date='+ trend.endDate;
    window.open(downloadurl2);
  ...
  callDateApply5(trend,id){
    // var id:any;
     ...
     if(!trend){
       let trend2:object;
       trend2={startDate:this.start.format('YYYY-MM-DD'),endDate:this.end.format('YYYY-MM-DD')}
       let downloadurl1 = 'http://152.135.122.61:8872/api/export_tools/'+id+'?start_date=' + this.start.format('YYYY-MM-DD') +'&end_date='+ this.end.format('YYYY-MM-DD');
       window.open(downloadurl1);
      //  this._service.sendDateGetReprts(trend2).subscribe(data=>{
      //   //window.open(downloadurl1);
      // })
      ...
      //  let downloadurl2 = 'http://152.135.122.61:8872/api/export_tool_xls/?start_date=' + trend.startDate +'&end_date='+ trend.endDate;
      let downloadurl2 = 'http://152.135.122.61:8872/api/export_tools/'+id+'?start_date=' + this.start.format('YYYY-MM-DD') +'&end_date='+ this.end.format('YYYY-MM-DD');
      window.open(downloadurl2);
      }
    }
}